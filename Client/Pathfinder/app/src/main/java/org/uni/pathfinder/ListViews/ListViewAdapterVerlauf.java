...
public class ListViewAdapterVerlauf extends ArrayAdapter<ListViewEntryVerlauf> implements View.OnClickListener{

    private ArrayList<ListViewEntryVerlauf> dataSet;
    Context mContext;
    ...
    public ListViewAdapterVerlauf(ArrayList<ListViewEntryVerlauf> data, Context context) {
    ...
    public ArrayList<ListViewEntryVerlauf> getDataSet() {
        return dataSet;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ListViewEntryVerlauf dataModel = getItem(position);
